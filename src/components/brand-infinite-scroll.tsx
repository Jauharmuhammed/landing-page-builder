...
const BrandInfiniteScroll = (props: Props) => {
    return (
        <>
            <div className="w-full py-36 inline-flex flex-nowrap overflow-hidden [mask-image:_linear-gradient(to_right,transparent_0,_black_128px,_black_calc(100%-128px),transparent_100%)]">
                {Array(3)
                    .fill(1)
                    .map((value) => (
                        <ul
